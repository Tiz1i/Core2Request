        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<int>(type: "int", nullable: false),
                    PostId = table.Column<int>(type: "int", nullable: false),
                    PostiQePelqehetPostId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Comments", x => x.CommentId);
                    table.ForeignKey(
                        name: "FK_Comments_Posts_PostiQePelqehetPostId",
                        column: x => x.PostiQePelqehetPostId,
                        principalTable: "Posts",
                        principalColumn: "PostId");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Comments_PostiQePelqehetPostId",
                table: "Comments",
                column: "PostiQePelqehetPostId");
